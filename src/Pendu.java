...
public class Pendu extends Application {
    ...
    private Pane fenetreJeu(){
        ...
        resetWordButton.setOnAction(controleLancerPartie);
    ...
    public void majAffichage(){
        if (this.modelePendu.getLettresEssayees().size() == 0) {
            this.pg.setProgress(0.0);
        } else {
            this.pg.setProgress(this.modelePendu.getMotATrouve().length()/this.modelePendu.getNbLettresRestantes()+1);
        }
        this.motCrypte.setText(this.modelePendu.getMotCrypte());
